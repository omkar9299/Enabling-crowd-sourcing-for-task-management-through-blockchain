 ...
 * @author 2533
 */
public class ProUpdateFrame extends javax.swing.JFrame {

    /**
     * Creates new form ProUpdateregFrame
     */
    public ProUpdateFrame() {
        super("Provider Registration Updation");
        initComponents();
        ArrayList fetchpro = new ProDataFetcher().getDetails(ProLoginFrame.uname);
  ...
  public boolean isValidEmail(String email)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProUpdateFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProUpdateFrame().setVisible(true);
            }
        });
    }
