 ...
 * @author 2533
 */
public class ProOperationFrame extends javax.swing.JFrame {

    /**
     * Creates new form ProOperationFrame
     */
    public ProOperationFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProOperationFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProOperationFrame().setVisible(true);
            }
        });
    }
