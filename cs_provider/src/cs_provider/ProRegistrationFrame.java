 ...
 * @author DELL
 */
public class ProRegistrationFrame extends javax.swing.JFrame {

    /**
     * Creates new form RegistrationFrame
     */
    private String balance = "100000";
    public ProRegistrationFrame() {
  ...
  //prasad9988774455pra@123.compra123 
        ...
        else
        {
            ...
            RegistrationMaker ss=new RegistrationMaker();
             if (ss.registerProvider(name, mob, email, uname, pw, balance,sign))
             {
   ...
   public boolean isValidEmail(String email)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        ProLoginFrame mf=new ProLoginFrame();
       Dimension d=Toolkit.getDefaultToolkit().getScreenSize();
       mf.setVisible(true);
       mf.setSize(d);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProRegistrationFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProRegistrationFrame().setVisible(true);
            }
        });
    }
