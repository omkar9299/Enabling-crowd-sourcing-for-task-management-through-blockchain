 ...
 * @author 2533
 */
public class WoOperationFrame extends javax.swing.JFrame {

    /**
     * Creates new form ProOperationFrame
     */
    public WoOperationFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WoOperationFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WoOperationFrame().setVisible(true);
            }
        });
    }
