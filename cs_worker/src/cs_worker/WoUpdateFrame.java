 ...
 * @author 2533
 */
public class WoUpdateFrame extends javax.swing.JFrame {

    /**
     * Creates new form ProUpdateregFrame
     */
    public WoUpdateFrame() {
        super("Provider Registration Updation");
        initComponents();
        ArrayList fetchpro = new WoDataFetcher().getDetails(WoLoginFrame.uname);
  ...
  public boolean isValidEmail(String email)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WoUpdateFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WoUpdateFrame().setVisible(true);
            }
        });
    }
